-- =====================================================
-- Persat Finance — MySQL 8.0+ Schema (LyteHosting)
-- Import via cPanel → phpMyAdmin → Import
-- Same as backend/database/schema.sql (keep in sync)
-- =====================================================

-- On cPanel you usually already selected the database — skip CREATE DATABASE
-- if phpMyAdmin is scoped to your DB. Uncomment only if you have full rights:
