/**
 * Synchronous SHA-256, dependency-free, for hashing small protocol payloads
 * (86-byte terms layouts, discriminator recomputation in tests). Not intended
 * for bulk data. Validated bit-for-bit against node:crypto by the protocol
 * test suite.
 */
